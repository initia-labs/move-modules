...
module nft_transfer::nft_transfer {
    ...
    fun add_cb_to_memo(memo: String, callback_id: u64): String {
        ...
        let cb_obj = AsyncCallbackObject {
            id: id,
            module_address: address::to_string(@nft_transfer),
    ...
    fun test_callback_ack_success(
        ...
        let collection_obj = object::address_to_object(initia_std::collection::create_collection_address(signer::address_of(creator), &collection_name));

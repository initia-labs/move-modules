module me::minit_swap {
    ...
    public entry fun create_pool(
        ...
        let module_store = borrow_global_mut<ModuleStore>(@me);
    ...
    fun share_token_metadata(): Object<Metadata> {
        let addr = object::create_object_address(@me, SYMBOL);
        object::address_to_object<Metadata>(addr)
    }
    ...
    fun assert_is_chain(_account: &signer) {
        ...
        // assert!(addr == @me, error::permission_denied(ENOT_CHAIN));
    }
